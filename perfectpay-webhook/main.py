...
def webhook():
    ...
    if response.status_code == 201:
        ...
        return f'{customer_email} - Usuário criado com sucesso.'
    else:
        logging.error(f'Erro ao criar usuário para o email: {customer_email}')
        return f'{customer_email} - Erro ao criar usuário.'
